...
function smarty_enqueue_scripts() {
    if ( is_checkout() ) {
        wp_enqueue_script('smarty-validation-js', plugins_url('dist/js/bundle.js', __FILE__), array(), '1.0', true);
        wp_enqueue_style( 'smarty-validation-css', plugins_url( 'dist/css/style.css', __FILE__ ), array(), '1.0' );
    }
}
