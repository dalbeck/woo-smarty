(function($) {
    $(document).ready(function() {
        ...
        window.isMissingApartmentNumber = false;
        ...
        function handleAddressValidation(fields, addressType) {
            ...
            if (!window.bypassApiCall && window.allRequiredFieldsFilled(requiredFields)) {
                ...
                fetch(requestUrl)
                    ...
                    .then(data => {
                        ...
                        if (data.length > 0 && data[0].components) {
                            ...
                            if (metadata.record_type === 'H' && !street2 && !window.isMissingApartmentNumber) {
